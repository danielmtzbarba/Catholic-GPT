...
class Database(object):
    def __init__(self, db_path):
        ...
        self._db = Chroma(persist_directory=db_path, embedding_function=self._embedding_function)
...
class RAG(Database):
    ...
    def _create_prompt(self, results):
        ...
        if len(results) == 0 or results[0][1] < 0.7:
            ...
            self._prompt = prompt_template.format(context=context_text, question=self._query.content)
        return self._prompt
